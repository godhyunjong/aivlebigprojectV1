    ...
    <v-container>
        ...
        <div class="panel">
            <div class="gs-bundle-of-buttons" style="max-height:10vh;">
                ...
                <v-btn :disabled="!selectedRow" style="margin-left: 5px;" @click="resistFuneralInfo" class="contrast-primary-text" small color="primary" >
                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="NameHangeul">{{ val.nameHangeul }}</td>
        ...
        <v-col>
            ...
            >
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            <String label="NameHangeul" v-model="selectedRow.nameHangeul" :editMode="true"/>
...
export default {
    ...
    methods:{
        async resistFuneralInfo(){
            try{
                var path = "resistFuneralInfo".toLowerCase();
                var temp = await this.repository.invoke(this.selectedRow, path, null)
                // 스넥바 관련 수정 필요
                // this.$EventBus.$emit('show-success','resistFuneralInfo 성공적으로 처리되었습니다.')
